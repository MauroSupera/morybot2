...
exports.optionCutFfmpeg = (type, fps = 15, width, height) => {
	switch (type) {
		...
		default:
			return [`-vcodec`,`libwebp`,`-vf`,`scale=512:512,fps=${fps}, pad=512:512:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`, `-loop`, `0`, `-ss`, `00:00:00`, `-t`, `00:00:11.0`]
	} 
}